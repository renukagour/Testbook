      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            <div className="overflow-hidden rounded-lg max-w-[30rem] max-h-[25rem] ">
              <img
          ...
          {/* Product info */}
          <div className="lg-col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:mx-w-7xl lg:px-8 lg:pb-4">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                      ...
                      {product.sizes.map((size) => (
                        ...
                        >
                          ...
                          {size.inStock ? (
                            <span
                              aria-hidden="true"
                              className="pointer-events-none absolute -inset-px rounded-md border-2 border-transparent group-data-[focus]:border group-data-[checked]:border-indigo-400"
                            />
                          ) : (
                            <span
                              aria-hidden="true"
                ...
                <Button
                  ...
                  variant="contained"
                  sx={{ px: "1.5rem", py: "1rem", bgcolor: "#653bba", mt: 2 }}
                >
                  Add To Cart
                </Button>
              </form>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-70">598490 Ratings</p>
                </div>
        ...
        <section className="pt-10">
          <h1 className="font-semibold text-xl py-5">Similar Products</h1>
