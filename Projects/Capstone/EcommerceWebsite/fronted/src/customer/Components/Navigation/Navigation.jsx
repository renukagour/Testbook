...
export default function Navigation() {
  ...
  useEffect(() => {
    if (auth.user) {
      // console.log("in navigation ", auth.user);
      handleClose();
    }
  ...
  return (
    <div className="bg-white pb-50">
      ...
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" onClose={setOpen} className="relative z-40 lg:hidden">
          <Transition.Child
            as={Fragment}
                        ...
                        <Tab
                          ...
                          className={({ selected }) =>
                            classNames(
                              ...
                              "flex-1 whitespace-nowrap border-b-2 py-4 px-1 text-base font-medium border-none"
                            )
                          }
                        >
                          {category.name}
