// Action types for adding an item to the cart
...
// Action types for getting the cart
export const GET_CART_REQUEST = 'GET_CART_REQUEST';
export const GET_CART_SUCCESS = 'GET_CART_SUCCESS';
export const GET_CART_FAILURE = 'GET_CART_FAILURE';

// Action types for removing an item from the cart
export const REMOVE_CART_ITEM_REQUEST = 'REMOVE_ITEM_CART_REQUEST';
...
// Action types for updating an item in the cart
